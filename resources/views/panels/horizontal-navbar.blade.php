      ...
      <div class="navbar-collapse" id="navbar-mobile">
        ...
        <ul class="nav navbar-nav float-right d-flex align-items-center">
          ...
          <li class="dropdown dropdown-notification nav-item">
            <a class="nav-link nav-link-label"  target="_blank" href="https://www.facebook.com/cubisoftofficial/">
              <i class="ficon bx bxl-facebook-circle bx-tada bx-flip-horizontal"></i>
              
            </a>
          </li>
          <li class="dropdown dropdown-notification nav-item">
            <a class="nav-link nav-link-label"  target="_blank" href="https://twitter.com/CubiGaming/">
              <i class="ficon bx bxl-twitter bx-tada bx-flip-horizontal"></i>
